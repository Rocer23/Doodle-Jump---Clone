...
player = pygame.transform.scale(pygame.image.load('lik-right@2x.png'), (90, 70))
fps = 60
...
pygame.display.set_caption("Doodle Jumper - Clone")
...
while running:
    ...
    for i in range(len(platforms)):
        ...
        # score_text = font.render('Air Jumps (Spacebar): ' + str(super_jump), True, black, background)
        # screen.blit(score_text, (210, 0))
        if game_over:
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE and game_over:
                ...
                platforms = [[175, 480, 70, 10], [85, 370, 70, 10], [265, 370, 70, 10], [175, 260, 70, 10],
                             [85, 150, 70, 10],
                             [265, 150, 70, 10], [175, 40, 70, 10]]
            if event.key == pygame.K_SPACE and game_over and super_jump > 0:
                super_jump -= 1
                y_change = -15
    ...
    if x_change > 0:
        ...
        player = pygame.transform.flip(pygame.transform.scale(pygame.image.load('lik-right@2x.png'), (90, 70)), 1, 0)
